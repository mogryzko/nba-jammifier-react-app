...
def get_masks(gif, dunk_start, dunk_end, xy, mask_rcnn_model, graph, save=True, folder= './russ_dunk'):
    #Input:
    # gif - iterable of images
    # dunk_start - frame num of jump/dunk start
    # dunk_end - frame num of jump/dunk end
    ...
    masks = []
    for idx in range(dunk_start, dunk_end + 1):
        frame = gif[idx]
        # Run detection
        frame = frame[:, :, :3]
